    ...
    <RevealSection id="about">
      <Container className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <motion.div variants={scaleIn}>
          <Card className="relative min-h-[420px] overflow-hidden bg-white/[0.03] p-0">
            <div className="relative flex min-h-[420px] flex-col justify-end">
              ...
              <div className="relative z-10 flex items-end justify-between gap-4 p-5 md:p-6">
                <div className="max-w-[60%]">
                  <p className="text-xl font-semibold tracking-[-0.05em] text-white md:text-2xl">
                    {founder.name}
                  </p>
